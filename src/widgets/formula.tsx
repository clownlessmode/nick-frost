...
const FormulaItem = ({
  ...
  return (
    <div className="2xl:pt-[20px] 2xl:h-[517px] overflow-hidden flex flex-col justify-between bg-[linear-gradient(to_bottom,white_70%,#1C8F74_100%)] mt-[20px] px-[10px] sm:px-[40px] md:px-[2px] lg:px-[2px] pt-[10px] sm:pt-[40px] md:pt-[8px] lg:pt-[12px] rounded-[5%] md:rounded-[20px] w-full max-w-[280px] sm:max-w-[600px] md:max-w-[170px] lg:max-w-[231px] 2xl:max-w-[354px] h-[250px] sm:h-[534px] md:h-[250px] lg:h-[338px] text-black">
